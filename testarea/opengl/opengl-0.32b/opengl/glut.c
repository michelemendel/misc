...
VALUE obj,arg1,arg2,arg3,arg4,arg5;
{
    ...
    width = NUM2INT(arg4);
    height = NUM2INT(arg5);
    ret = glut_CreateSubWindow(win, x, y, width, height);
    return INT2NUM(ret);
}
...
/* GLUT menu sub-API. */
static VALUE createmenu_func = Qnil;
static void
glut_CreateMenuCallback(value)
int value;
{
    if (!NIL_P(createmenu_func))
        rb_funcall(createmenu_func, callId, 1, INT2NUM(value));
}
...
VALUE obj,arg1;
{
    ...
    createmenu_func = arg1;
    ret = glutCreateMenu(glut_CreateMenuCallback);
    return INT2FIX(ret);
}
...
VALUE obj,arg1,arg2;
{
    ...
    value = NUM2INT(arg2);
    glutAddMenuEntry(RSTRING(arg1)->ptr, value);
    return Qnil;
}
...
VALUE obj,arg1,arg2,arg3;
{
    ...
    if (TYPE(arg2) != T_STRING) rb_raise(rb_eTypeError, "GLUT.ChangeToMenuEntry:%s",
              rb_class2name(CLASS_OF(arg1)));
    glutChangeToMenuEntry(item, RSTRING(arg2)->ptr, value);
    return Qnil;
}
